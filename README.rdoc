...
You can make use of MailChimp's {STS API}[http://apidocs.mailchimp.com/sts/1.0/] by creating an STS object:
...
You can run any of the commands listed in the {STS API Documentation}[http://apidocs.mailchimp.com/sts/1.0/]:
